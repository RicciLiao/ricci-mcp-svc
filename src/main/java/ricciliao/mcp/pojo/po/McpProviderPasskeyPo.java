...
@Entity
@Table(name = "mcp_provider_passkey", schema = "mcp")
public class McpProviderPasskeyPo implements Serializable {
    @Serial
    private static final long serialVersionUID = -7687334774262327008L;
