...
public class ProviderController {
    ...
    @Operation(description = "Retrieve provider passkey")
    @GetMapping("/passkey/{id}")
    public Response<PayloadData> passkey(@PathVariable("id") Long id) {

        return ResponseUtils.success(SimplePayloadData.of(providerService.passkey(id)));
    }
